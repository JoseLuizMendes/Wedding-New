...
async function main() {
    ...
    console.log('🌙 Criando meta de Lua de Mel...');
    ...
    console.log(`   🌙 Meta Lua de Mel: R$ ${honeymoonGoal?.targetAmount} (Ativa: ${honeymoonGoal?.isActive})`);
}
